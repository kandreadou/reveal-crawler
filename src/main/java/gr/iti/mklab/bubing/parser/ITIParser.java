 ...
 */
public class ITIParser<T> implements Parser<T> {
    private static final Logger LOGGER = LoggerFactory.getLogger(ITIParser.class);
     ...
     */
    public ITIParser(final HashFunction hashFunction) {
     ...
     */
    public ITIParser(final HashFunction hashFunction, final TextProcessor<T> textProcessor, final boolean crossAuthorityDuplicates, final int bufferSize) {
     ...
     *                                 as they are assigned to the same {@link Agent}.
     */
    public ITIParser(final HashFunction hashFunction, final boolean crossAuthorityDuplicates) {
     ...
     *                                 as they are assigned to the same {@link Agent}.
     */
    public ITIParser(final HashFunction hashFunction, final TextProcessor<T> textProcessor, final boolean crossAuthorityDuplicates) {
     ...
     */
    public ITIParser(final String messageDigest) throws NoSuchAlgorithmException {
     ...
     * @throws NoSuchAlgorithmException
     */
    public ITIParser(final String messageDigest, final String crossAuthorityDuplicates) throws NoSuchAlgorithmException {
    ...
    public ITIParser(final String messageDigest, final String textProcessorSpec, final String crossAuthorityDuplicates) throws NoSuchAlgorithmException, IllegalArgumentException, ClassNotFoundException, IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchMethodException, IOException {
    ...
    @Override
    public ITIParser<T> clone() {
        return new ITIParser<T>(digestAppendable == null ? null : digestAppendable.hashFunction, textProcessor == null ? null : textProcessor.copy(), crossAuthorityDuplicates, buffer.length);
    }

    @Override
    public ITIParser<T> copy() {
        return clone();
    }
    ...
    public static void main(String arg[]) throws IllegalArgumentException, IOException, URISyntaxException, JSAPException, NoSuchAlgorithmException {
        ...
        final SimpleJSAP jsap = new SimpleJSAP(ITIParser.class.getName(), "Produce the digest of a page: the page is downloaded or passed as argument by specifying a file",
                new Parameter[]{
        ...
        final ITIParser<Void> htmlParser = new ITIParser<Void>(BinaryParser.forName(digester), (TextProcessor<Void>) null, crossAuthorityDuplicates, charBufferSize);
